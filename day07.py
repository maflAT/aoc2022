...
$ system-update --please --pretty-please-with-sugar-on-top Error: No space left on
device
...
need unused space of at least 30000000. You need to find a directory you can delete that
