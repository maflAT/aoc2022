...
This strategy guide predicts and recommends the following:
    ...
    because you won). In the second round, your opponent will choose Paper (B), and you
    should choose Rock (X). This ends in a loss for you with a score of 1 (1 + 0). The
    third round is a draw with both players choosing Scissors, giving you a score of 3 +
    3 = 6.
...
shape to choose so the round ends as indicated. The example above now goes like this:
  ...
  - In the second round, your opponent will choose Paper (B), and you choose Rock so
    youlose (X) with a score of 1 + 0 = 1. 
